...
storage. Resend for alert emails. An Evidence dashboard on Vercel, rebuilt from summary CSVs
that each run pushes to the repo. Why not Databricks:
[ADR 0002](docs/adr/0002-local-scheduled-script-with-duckdb.md). Why not Tableau Public:
...
4. Dashboard: summary CSV export, the publish step, and the Evidence site on Vercel.
